...
import structlog
from opentelemetry.sdk._logs._internal import LoggerProvider, LogRecord, std_to_otel
...
class StructlogHandler:
    ...
    @staticmethod
    def _parse_exception(event_dict: structlog.typing.EventDict) -> Mapping[str, str]:
        ...
        if exception is not None:
            ...
            attributes[exception_attributes.EXCEPTION_TYPE] = exc_type
            attributes[exception_attributes.EXCEPTION_MESSAGE] = message
            attributes[exception_attributes.EXCEPTION_STACKTRACE] = stack_trace
